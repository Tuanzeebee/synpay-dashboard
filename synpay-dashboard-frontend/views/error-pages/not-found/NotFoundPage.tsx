        ...
        <div className="max-w-2xl w-full">
          ...
          <div className="flex justify-center mb-8 relative">
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-32 h-32 bg-amber-500/20 dark:bg-amber-500/10 rounded-full animate-ping" />
            </div>
            <div className="relative w-32 h-32 bg-gradient-to-br from-amber-500 to-amber-600 dark:from-amber-600 dark:to-amber-700 rounded-full flex items-center justify-center shadow-xl animate-bounce">
          ...
          <Card className="shadow-xl">
            <CardContent className="p-8 md:p-12 text-center">
              {/* Error Code */}
              <div className="inline-block px-4 py-2 bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-400 rounded-lg text-sm font-semibold mb-4">
                Lỗi 404 - Not Found
              </div>
              ...
              {/* Divider */}
              <div className="w-16 h-1 bg-gradient-to-r from-amber-500 to-amber-600 rounded-full mx-auto mb-8" />
              ...
              <div className="pt-6 border-t border-slate-200 dark:border-slate-700">
                <p className="text-sm text-slate-500 dark:text-slate-400 mb-3">
                  Vẫn gặp vấn đề? Liên hệ với chúng tôi:
                </p>
